...
导演库不是把一个导演的名字追加到 Prompt 末尾。它会把导演通常如何选择故事瞬间、安排人物与空间、放置摄影机、使用真实光源和控制时间感，改写成当前场景里看得见的决定。代表作品只用于帮助你认识导演，不代表 Skill 会复制电影。
...
> 代表作品用于帮助你认识导演，不代表 Skill 会复制这些电影。导演姓名也不是 Prompt 魔法词，真正起作用的仍然是故事、人物、空间、摄影机和光线。
